...
public final class TrakStokService extends ServiceBase {
    ...
    public static final WaveTypeBase DO_FIND_COMPANIES = WaveTypeBase.build("FIND_ALL_COMPANIES", TSWaves.USER);
    ...
    public static final WaveTypeBase DO_GET_USER = WaveTypeBase.build("GET_USER");
    public static final WaveTypeBase RE_ON_GET_USER = WaveTypeBase.build("ON_FIND_USER", TSWaves.USER);
    /**
     * The class logger.
     */
    ...
    public void ready() throws CoreException {
        ...
        registerCallback(DO_GET_USER, RE_ON_GET_USER);
        registerCallback(DO_FIND_COMPANIES, RE_ON_FIND_COMPANIES);

    }

    public User doGetUser(final Wave wave) {
    ...
    public List<Company> doFindAllCompanies(final User user, final Wave wave) {

        LOGGER.info("doFindAllCompanies()");
